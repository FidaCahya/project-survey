            ...
            <div class="container-fluid d-flex align-items-center justify-content-center flex-column" style="height: 80%;">
                <div class="text-center pb-5">
                    <h1 class="text-head-primary">
                        Selamat Datang <?php echo ucfirst($username);?>!
                    </h1>
                ...
                <div class="d-flex pb-3" style="width: 100%;"><a href="survey_view_pendidikan.php" class="btn-primary" style="width: 100%;border-radius: 0;">Survey Pendidikan</a></div>
                    <div class="d-flex pb-3" style="width: 100%;"><a href="survey_view_fasilitas.php" class="btn-primary" style="width: 100%;border-radius: 0;">Survey Fasilitas</a></div>
                    <div class="d-flex pb-3" style="width: 100%;"><a href="survey_view_layanan.php" class="btn-primary" style="width: 100%;border-radius: 0;">Survey Layanan</a></div>
                    <div class="d-flex pb-3" style="width: 100%;"><a href="survey_view_alumni.php" class="btn-primary" style="width: 100%;border-radius: 0;">Survey Lulusan</a></div>
                 </div>
            </div>
            <!-- MAIN END -->
            <!-- HEADER -->
