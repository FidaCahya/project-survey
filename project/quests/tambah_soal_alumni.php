...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $survey_id = 14; // Replace with your actual survey_id
    $kategori_id = 4; // Replace with your actual kategori_id
    ...
    echo '<script>
            function showConfirmation() {
                ...
                window.location.href = "survey_edit_alumni.php";
            }
            showConfirmation();
          </script>';
    exit();
...
$dst = 4; // or another appropriate value for the type of survey
?>
