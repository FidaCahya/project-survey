...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $survey_id = 10; // Replace with your actual survey_id
    $kategori_id = 8; // Replace with your actual kategori_id
    ...
    echo '<script>
            function showConfirmation() {
                ...
                window.location.href = "survey_edit_fasilitas.php";
            }
            showConfirmation();
          </script>';
    exit();
...
$dst = 2; // or another appropriate value for the type of survey
?>
