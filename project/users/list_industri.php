<?php
    ...
    // Query untuk mengambil data responden industri dari tabel t_responden_industri
    $sql_responden = "SELECT responden_industri_id, responden_nama, responden_tanggal FROM t_responden_industri";
                    ...
                    <table class="text-primary user-list">
                        ...
                        if ($result_responden->num_rows > 0) {
                            ...
                            while($row = $result_responden->fetch_assoc()) {
                                ...
                                echo "<td><a href='detail_responden.php?id=" . $row["responden_industri_id"] . "' class='d-flex justify-content-center btn-primary' style='border-radius: 0.5rem;padding: 0.5rem 0.75rem;'>";
