...
<?php
    ...
    // Query untuk mengambil data responden dosen dari tabel t_responden_dosen
    $sql_responden = "SELECT responden_dosen_id, responden_nama, responden_tanggal FROM t_responden_dosen";
                    ...
                    <table class="text-primary user-list">
                        ...
                        if ($result_responden->num_rows > 0) {
                            ...
                            while($row = $result_responden->fetch_assoc()) {
                                ...
                                echo "<td><a href='detail_responden_dosen.php?id=" . $row["responden_dosen_id"] . "' class='d-flex justify-content-center btn-primary' style='border-radius: 0.5rem;padding: 0.5rem 0.75rem;'>";
