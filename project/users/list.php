<?php 
    ...
    // Query untuk mengambil data responden mahasiswa dari tabel t_responden_mahasiswa
    $sql_responden = "SELECT responden_mahasiswa_id, responden_nama, responden_tanggal FROM t_responden_mahasiswa";
                    ...
                    <table class="text-primary user-list">
                        ...
                        if ($result_responden->num_rows > 0) {
                            ...
                            while($row = $result_responden->fetch_assoc()) {
                                ...
                                echo "<td><a href='quest-results.php?id=" . $row["responden_mahasiswa_id"] . "' class='d-flex justify-content-center btn-primary' style='border-radius: 0.5rem;padding: 0.5rem 0.75rem;'>";
