<?php
    ...
    // Query untuk mengambil data responden alumni dari tabel t_responden_alumni
    $sql_responden = "SELECT responden_alumni_id, responden_nama, responden_tanggal FROM t_responden_alumni";
                    ...
                    <table class="text-primary user-list">
                        ...
                        if ($result_responden->num_rows > 0) {
                            ...
                            while($row = $result_responden->fetch_assoc()) {
                                ...
                                echo "<td><a href='detail_responden.php?id=" . $row["responden_alumni_id"] . "' class='d-flex justify-content-center btn-primary' style='border-radius: 0.5rem;padding: 0.5rem 0.75rem;'>";
