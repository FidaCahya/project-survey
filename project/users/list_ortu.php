...
<?php
    ...
    // Query untuk mengambil data responden orang tua dari tabel t_responden_ortu
    $sql_responden = "SELECT responden_ortu_id, responden_nama, responden_tanggal FROM t_responden_ortu";
                    ...
                    <table class="text-primary user-list">
                        ...
                        if ($result_responden->num_rows > 0) {
                            ...
                            while($row = $result_responden->fetch_assoc()) {
                                ...
                                echo "<td><a href='detail_responden_ortu.php?id=" . $row["responden_ortu_id"] . "' class='d-flex justify-content-center btn-primary' style='border-radius: 0.5rem;padding: 0.5rem 0.75rem;'>";
