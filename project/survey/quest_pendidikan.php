...
switch ($role_key) {
    case 'mahasiswa':
        $survey_id = 1; // Example value, replace with actual value for mahasiswa
        $kategori_id = 1; // Example value, replace with actual value for mahasiswa
        break;
    case 'ortu':
        $survey_id = 1; // Example value, replace with actual value for orangtua
        $kategori_id = 1; // Example value, replace with actual value for orangtua
        break;
    case 'alumni':
        $survey_id = 1; // Example value, replace with actual value for alumni
        $kategori_id = 1; // Example value, replace with actual value for alumni
        break;
    case 'tendik':
        $survey_id = 1; // Example value, replace with actual value for tendik
        $kategori_id = 1; // Example value, replace with actual value for tendik
        break;
    case 'industri':
        $survey_id = 6; // Example value, replace with actual value for industri
        $kategori_id = 1; // Example value, replace with actual value for industri
        break;
    case 'dosen':
        $survey_id = 1; // Example value, replace with actual value for dosen
        $kategori_id = 1; // Example value, replace with actual value for dosen
        break;
    default:
        header("Location:landing_page.php");
        exit();
