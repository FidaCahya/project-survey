<?php
    ...
    // Ambil user_id dari tabel m_user berdasarkan nama
    $sql_user_id = "SELECT user_id FROM m_user WHERE nama = '$username'";
    ...
    if ($result_user_id && mysqli_num_rows($result_user_id) > 0) {
        ...
        $responden_mahasiswa_id = $row_user_id['user_id'];
    } else {
    ...
    if (isset($_GET['answ'])) {
        ...
        foreach ($answers as $question_id => $answer) {
            ...
            // Masukkan jawaban ke dalam database
            $sql = "INSERT INTO t_jawaban_mahasiswa (responden_mahasiswa_id, soal_id, jawaban) VALUES ('$responden_mahasiswa_id', '$question_id', '$answer')";
        ...
        echo "Tidak ada jawaban yang dikirimkan.";
    }
?>
