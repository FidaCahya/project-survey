...
$query =  "SELECT responden_nama, responden_nim, responden_prodi, responden_email, responden_hp, tahun_masuk
            FROM t_responden_mahasiswa
            INNER JOIN m_user ON t_responden_mahasiswa.responden_nama = m_user.nama 
            WHERE m_user.username = ?
            ORDER BY t_responden_mahasiswa.responden_tanggal DESC 
            LIMIT 1";
...
<html>
    ...
    <body>
        ...
        <nav class="vh-100 d-flex flex-column align-items-center" style="position: fixed;width: 20%;background-color: var(--primary); padding-top: 5rem; padding-bottom: 2rem;">
            ...
            <div class="container-fluid d-flex align-it ems-center justify-content-center text-secondary pb-2 nav-item">
        ...
        <div class="container-fluid bg-secondary d-flex align-content-stretch flex-column" style="margin-left: 20%; width: 80%; height: max-content; position: absolute;">
            ...
            <div class="container-fluid py-5 d-flex align-items-center justify-content-center flex-column" style="height: 100%;">
               ...
               <div class="d-flex flex-column justify-content-center align-items-center" style="width: 100%;">
                ...
                <div class="d-flex" style="width: 100%; padding-bottom: 1.5rem;">
                    <label for="hp" class="form-label" style="width: 100%;">NIM:</label>
                    <input id="hp" class="form-control" type="text" value="<?php echo ($nim); ?>" readonly style="width: 100%; min-width: 20rem;">
                </div>
                <div class="d-flex" style="width: 100%; padding-bottom: 1.5rem;">
                    <label for="pendidikan" class="form-label" style="width: 100%;">Prodi:</label>
                    <input id="pendidikan" class="form-control" type="text" value="<?php echo ($prodi); ?>" readonly style="width: 100%; min-width: 20rem;">
                </div>
                <div class="d-flex" style="width: 100%; padding-bottom: 1.5rem;">
                ...
                <div class="d-flex" style="width: 100%; padding-bottom: 1.5rem;">
                    <label for="penghasilan" class="form-label" style="width: 100%;">Nomor Telepon:</label>
                    <input id="penghasilan" class="form-control" type="text" value="<?php echo ($hp); ?>" readonly style="width: 100%; min-width: 20rem;">
                </div>
                <div class="d-flex" style="width: 100%; padding-bottom: 1.5rem;">
                    <label for="mahasiswa_nama" class="form-label" style="width: 100%;">Tahun Masuk:</label>
                    <input id="mahasiswa_nama" class="form-control" type="text" value="<?php echo ($tahun_masuk); ?>" readonly style="width: 100%; min-width: 20rem;">
                </div> 
                    </form>
                </div>
                <!-- FORM END -->
