...
$query =  "SELECT responden_nama, responden_nip, responden_unit 
            FROM t_responden_dosen 
            INNER JOIN m_user ON t_responden_dosen.responden_nama = m_user.nama 
            WHERE m_user.username = ?
            ORDER BY t_responden_dosen.responden_tanggal DESC 
            LIMIT 1";
...
<html>
    ...
    <div class="d-flex flex-column justify-content-center align-items-center" style="width: 100%;">
        ...
        <div class="d-flex" style="width: 100%; padding-bottom: 1.5rem;">
            ...
            <input id="nopeg" class="form-control" type="text" value="<?php echo ($nip); ?>" readonly style="width: 100%; min-width: 20rem;">
        </div>
        <div class="d-flex" style="width: 100%; padding-bottom: 1.5rem;">
