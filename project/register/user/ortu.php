...
<html>
    ...
    <body>
        <div class="container-fluid">
            ...
            <form action="ortu_action.php" method="POST">
                ...
                <div class="container-fluid d-flex flex-row">
                    <div class="container-fluid d-flex flex-column align-items-center justify-content-center">
                        ...
                        <div class="d-flex flex-column justify-content-center align-items-center" style="width: 30%;">
                            ...
                            <div class="d-flex" style="width: 100%;padding-bottom: 1.5rem">
                                <input class="form-control" type="text" name="jenisKelamin" placeholder="Jenis Kelamin (L/P)">
                            </div>
                            <div class="d-flex" style="width: 100%;padding-bottom: 1.5rem">
                            ...
                            <div class="d-flex" style="width: 100%;padding-bottom: 1.5rem">
                                <input class="form-control" type="text" name="pendidikan" placeholder="Pendidikan">
                            </div>
                            <div class="d-flex" style="width: 100%;padding-bottom: 1.5rem">
                                <input class="form-control" type="text" name="pekerjaan" placeholder="Pekerjaan">
                            </div>
                            <div class="d-flex" style="width: 100%;padding-bottom: 1.5rem">
                                <input class="form-control" type="text" name="penghasilan" placeholder="Penghasilan">
                            </div>
                            <div class="d-flex" style="width: 100%;padding-bottom: 1.5rem">
                                <input class="form-control" type="text" name="namaMhs" placeholder="Nama Mahasiswa">
                            </div>
                            <div class="d-flex" style="width: 100%;padding-bottom: 1.5rem">
                                <input class="form-control" type="text" name="prodiMhs" placeholder="Prodi Mahasiswa">
                            </div>
                        </div>
                    </div>
