        ...
        <div class="container-fluid d-flex align-items-center justify-content-center flex-column" style="height: 80%;">
            <div class="text-center pb-5">
                <h1 class="text-head-primary">
                    Selamat Datang di Survey Polinema!
                </h1>
            ...
            <div style="width: 20rem;">
                <div class="d-flex pb-3" style="width: 100%;"><a href="survey/guide.php?dst=pendidikan" class="btn-primary" style="width: 100%;border-radius: 0;">Survey Pendidikan</a></div>
                <div class="d-flex pb-3" style="width: 100%;"><a href="survey/guide.php?dst=fasilitas" class="btn-primary" style="width: 100%;border-radius: 0;">Survey Fasilitas</a></div>
                <div class="d-flex pb-3" style="width: 100%;"><a href="survey/guide.php?dst=layanan" class="btn-primary" style="width: 100%;border-radius: 0;">Survey Layanan</a></div>
                <div class="d-flex pb-3" style="width: 100%;"><a href="survey/guide.php?dst=lulusan" class="btn-primary" style="width: 100%;border-radius: 0;">Survey Lulusan</a></div>
            </div>
        </div>
        <!-- MAIN END -->
        <!-- HEADER -->
